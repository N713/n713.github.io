...
window.addEventListener('DOMContentLoaded', () => {
    ...
    function setLanguage(lang) {
        ...
        document.querySelector('.roulette__in img').setAttribute('src', `${translations[lang].wheel}`);
    }
